...
def popup_save_recording(window, font, recordingSave, avi_recorder, timestamp, recording, avi_filename, is_jf_mode, recordingStartEnd):
    ...
    while running_popup:
        ...
        if result["choice"] == "yes":
            ...
            recordingSave(recording, avi_recorder,timestamp, is_jf_mode)
            return False
